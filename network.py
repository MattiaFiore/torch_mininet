...
# Set CPU affinity for h1 (use cores 0, 1, 2)
set_cpu_affinity(net.get('h0'), [0, 1, 2])
    
# Set CPU affinity for h2 (use cores 3, 4, 5, 6)
set_cpu_affinity(net.get('h1'), [3, 4, 5, 6, 7, 8, 9])
